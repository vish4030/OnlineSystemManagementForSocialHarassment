...
VictimizerMaster(FullName,Age,Gender,Mobile,Email,Address,State,Country,Pincode,City) VALUES
('$TxtFullName','$TxtAge','$Gender','$TxtMobile','$TxtEmail','$TxtAddress','$TxtState','$TxtCountry','$TxtPincode','$TxtCity')");
...
if (isset($_POST['Delete1'])) {
    $abc = "DELETE FROM VictimizerMaster WHERE Email='$TxtEmail'";
...
if (isset($_POST['srchval'])) {
    $query2 = "SELECT * FROM VictimizerMaster WHERE Email = '$sch'";
...
if (isset($_POST['Update1'])) {
    $query1 = "UPDATE VictimizerMaster SET
FullName='$TxtFullName', Age='$TxtAge',Gender='$Gender',Mobile='$TxtMobile',Address='$TxtAddress', City='$TxtCity',State='$TxtState',Country='$TxtCountry',Pincode='$TxtPincode' WHERE Email='$TxtEmail'";
...
<nav class="navbar navbar-expand-lg font-weight-bold" style="background-color:blue;">
        <div class="collapse navbar-collapse container" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link text-white" href="./victimizer.php">Victimizer Details</a>
                </li>
            </ul>
        </div>
    </nav>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <select name="srchval" id="fn" class="custom-select">
                            ...
                            <?php
                            $res = mysqli_query($conn, "SELECT Email FROM VictimizerMaster");
